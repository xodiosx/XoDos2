...
expect "Otherwise it's not recommended to mount the entire internal storage"
sleep 1
send "\x0e\x0e\r"
...
expect "Mount the host's home directory inside the container"
sleep 1
send "\x0e\x0e\r"
