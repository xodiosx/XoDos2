...
class Workflow {
  ...
  static Future<void> setupBootstrap() async {
    ...
    // These are some tiny patches that will be mounted to ~/.local/share/tiny
    await Util.copyAsset(
    "assets/patch.tar.gz",
